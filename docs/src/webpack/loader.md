...
通常使用 npm 进行管理，但是也可以将自定义 loader 作为应用程序中的文件。按照约定，loader 通常被命名为 `xxx-loader`（例如 `json-loader`）。更多详细信息请查看 [如何编写 loader？](https://v4.webpack.docschina.org/contribute/writing-a-loader)。
